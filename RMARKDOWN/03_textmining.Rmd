...
DB$DESCRI_PEDIDO1 =gsub("\\b(eletricidade)", "eletrica", DB$DESCRI_PEDIDO1)
DB$DESCRI_PEDIDO1 =gsub("\\b(energetica)", "eletrica", DB$DESCRI_PEDIDO1)
DB$DESCRI_PEDIDO1 =gsub("\\b(energeticas)", "eletrica", DB$DESCRI_PEDIDO1)
DB$DESCRI_PEDIDO1 =gsub("\\b(energetico)", "eletrica", DB$DESCRI_PEDIDO1)
DB$DESCRI_PEDIDO1 =gsub("\\b(energeticos)", "eletrica", DB$DESCRI_PEDIDO1)
DB$DESCRI_PEDIDO1 =gsub("\\b(energia)", "eletrica", DB$DESCRI_PEDIDO1)
DB$DESCRI_PEDIDO1 =gsub("\\b(energias)", "eletrica", DB$DESCRI_PEDIDO1)
DB$DESCRI_PEDIDO1 =gsub("\\b(energy)", "eletrica", DB$DESCRI_PEDIDO1)
DB$DESCRI_PEDIDO1 =gsub("\\b(energies)", "eletrica", DB$DESCRI_PEDIDO1)
x#DB$DESCRI_PEDIDO1 =gsub("\\b(Termoeletricas)", "termoeletrica", DB$DESCRI_PEDIDO1)
