...
# https://rstudio.github.io/shinydashboard/appearance.html#logout-panel
...
# https://fontawesome.com/icons?d=gallery&q=bar
...
list.of.packages <- c("backports","bibtex","caret","class","cluster","curl","devtools",
                      "dplyr","DT","e1071","highcharter","knitr","keras","kableExtra","lsa","ptstem","quanteda",
                      "randomForest","readxl","reticulate","rpart","rpart.plot","rsconnect","rslp","shiny",
                      "shinydashboard","shinythemes","stringr","scales","tibble","tidyr","tidytext","tidyverse",
  ...
  output$tb <- renderUI({
    if(is.null(input$file)) {return(
      mainPanel(
        ...
        list(
          titlePanel("Modelo de Intelig. Artificial p/ Classificação de Textos"),
          br(),
          shiny::h4(
            "MineraLAI é uma aplicação web (webapp) ",
            shiny::a(href = 'http://shiny.rstudio.com', 'Shiny'),
            " desenvolvido em linguagem R e tem por finalidade simular uma demonstração de utilidade de um modelo de classificação de texto via Random Forest (RF), donde o problema inicial proposto é derivado de uma classificação multinomial com 3 classes: 1. DEA; 2. DEE; 3. OUTROS. "
            ),
          br(),
          shiny::h4(
            "Para isso, alguns pacotes importantes e de fácil utilidade como",
            #shiny::a(href = 'https://plot.ly/r/', 'plotly'),
            #",",
            #shiny::a(href = 'https://rstudio.github.io/leaflet/', 'Leaflet'),
            #",",
            shiny::a(href = 'https://www.tidyverse.org', 'Tidyverse'),
            " (coleção de bibliotecas R para cientistas de dados),",
            shiny::a(href = 'https://cran.r-project.org/package=highcharter', 'Highcharts'),
            " (gráficos interativos e dinâmicos),",
            shiny::a(href = 'https://www.tidytextmining.com', 'Topic Models (tm)'),
            " e ",
            shiny::a(href = 'https://www.tidytextmining.com', 'Tidy Text'),
            " (mineração de texto),",
            shiny::a(href = 'https://cran.r-project.org/web/packages/randomForest/randomForest.pdf', 'randomForest'),
            " (modelagem random forest para classificação e regressão),",
            shiny::a(href = 'https://cran.r-project.org/web/packages/STAT/STAT.pdf', 'Stats'),
            " (análise estatística para previsão de modelos),",
            shiny::a(href = 'https://cran.r-project.org/web/packages/kableExtra/kableExtra.pdf', 'kableExtra'),
            " e ",
            shiny::a(href = 'https://rstudio.github.io/DT/', 'DT'),
            " (criação de tabelas) são empregados nesse projeto",
            #shiny::a(href = 'https://cran.r-project.org/web/packages/googleVis/vignettes/googleVis_examples.html', 'googleVis'),
            "."
          ),
          br(),
          shiny::h4("Esse aplicativo web compõe o trabalho de conclusão de curso de Alize de F. Antunes Lea e Ewerson C. Pimenta apresentado à",
                    shiny::a(href = 'http://ence.ibge.gov.br', 'Escola Nacional de Ciências Estatísticas'),
                    " do ", 
                    shiny::a(href = 'https://ibge.gov.br', 'Instituto Brasileiro de Geografia e Estatística'),
          ...
          img(src = "https://uploads.toptal.io/blog/post_image/120783/nlp-tutorial-text-classification-60b609c0b7a2622d2b0d6122f2b27f97.png", width = 370),
          br(),
      ...
      tabsetPanel(
        ...
        navbarMenu("Random Forest (RF)",
                   tabPanel("Resultados treino", fluidRow(titlePanel("Resultados do modelo Treinado"),p("Taxa de erro Out of Bag (OOB) e matriz de confusãodo modelo treinado."),
                                                               ...
                                                               plotOutput(outputId = "RFOOB_plot", height = "700px", width = "400px"))),
                   tabPanel("Resultados teste", fluidRow(titlePanel("Matriz de confusão da base de teste"),
                                                               verbatimTextOutput("RF_confMatrix"))),
                   tabPanel("Termos Importantes", fluidRow(titlePanel("Gráfico de importância dos termos"),
                                                      #highchartOutput("highchart1", height = "650px", width = "470px")))  # MOBILE
                                                      highchartOutput("highchart1", height = "800px", width = "400px")))
                   ),
