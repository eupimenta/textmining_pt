...
#      
#      output$home <- reactive({
#        list(
#          h5("Olá, essa demonstração é de um projeto de trabalho de conclusão de curso."),
#          h6("Por favor leia as diretrizes ao lado."),
#          br(),
#          img(src = "https://uploads.toptal.io/blog/post_image/120783/nlp-tutorial-text-classification-60b609c0b7a2622d2b0d6122f2b27f97.png", width = 400),
#          br(),
#          p("...")
#        )
#      })
      ...
      output$tb <- renderUI({
        if(is.null(input$file)) {return()}
          ...
          tabsetPanel(
            #tabPanel("Sobre", verbatimTextOutput(home)),
