...
"),
          ...
          helpText("Versão atual V.4.1 concluída em 21/05/2019 às 00h42."),
        ...
        if(is.null(input$file)) {return(
          mainPanel(
            ...
            list(
              ...
              list(img(src = "https://leeoesterreich.org/wp-content/uploads/2018/10/shiny.png", height = 100),
                   img(src = "https://l3software.com.br/wp-content/uploads/2018/05/highcharts.jpg", height = 100),
                   img(src = "https://opensource.org/files/osi_standard_logo_0.png", height = 120),
                    img(src = "http://transparencia.confea.org.br/wp-content/uploads/2017/06/icone-sic.png", height = 100)),
                   #img(src = "https://www.rstudio.com/wp-content/uploads/2018/10/RStudio-Logo-Flat.png", height = 100)),
              br(),
              h6("Esse aplicativo web é inteiramente desenvolvido utilizando recursos de código livre e Open Source como código R e shiny")
