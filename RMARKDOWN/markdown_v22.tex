...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dicionario_pedidos =}\StringTok{ "DATA/Pedidos-Formato.txt"}
\NormalTok{dic =}\StringTok{ }\KeywordTok{read.delim}\NormalTok{(}\DataTypeTok{file =}\NormalTok{ dicionario_pedidos, }\DataTypeTok{sep =} \StringTok{"-"}\NormalTok{, }\DataTypeTok{skip =} \DecValTok{3}\NormalTok{, }\DataTypeTok{header =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{V1)}
\KeywordTok{colnames}\NormalTok{(dic) =}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Nome das variáveis"}\NormalTok{, }\StringTok{"Tipo e descrição da variável"}\NormalTok{)}
\CommentTok{#dimnames(dic); View(dic)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dic }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable}\NormalTok{(}\StringTok{"latex"}\NormalTok{, }\DataTypeTok{caption =} \StringTok{"Dicionário de variáveis da tabela de pedidos"}\NormalTok{,}
...
\caption{\label{tab:unnamed-chunk-10}Dicionário de variáveis da tabela de pedidos}
\centering
\begin{tabular}[t]{ll}
\hiderowcolors
\toprule
...
\caption{\label{tab:unnamed-chunk-22}Palavras mais frequentes no conjunto de solicitações}
\centering
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-24-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-27-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-28-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-29-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-30-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-31-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-32-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-33-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-34-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-35-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-36-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-37-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/02_freq_palavras_dir-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/03_freq_palavras_dir_nostop-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/03_freq_palavras_dir-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/04_freq_palavras_dir-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-41-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-41-2.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-41-3.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-41-4.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-41-5.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_onegram_DIR01_semstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_onegram_DIR02_semstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_onegram_DIR03_semstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_onegram_DIR04_semstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_onegram_DIR05_semstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_bigram_DIR01_semstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_bigram_DIR02_semstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_bigram_DIR03_semstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_bigram_DIR04_semstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_bigram_DIR05_semstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/unnamed-chunk-45-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_trigram_DIR01_comstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_trigram_DIR02_comstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_trigram_DIR03_comstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_trigram_DIR04_comstopwords-1.pdf}
...
\includegraphics{markdown_v22_files/figure-latex/wordcloud_trigram_DIR05_comstopwords-1.pdf}
...
\caption{\label{tab:unnamed-chunk-47}Amostra dos dados a serem pré-processados}
\centering
