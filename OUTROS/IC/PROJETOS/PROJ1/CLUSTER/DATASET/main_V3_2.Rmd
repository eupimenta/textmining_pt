...
geom_bar(stat = "identity", fill = "pink", aes(color = I('white')), size = 0.3)+
xlab('Variáveis')+
...
# draw the plot grid
#library(gridExtra)
#grid.arrange(p0.1, ncol=1)
ggarrange(p0.1, ncol=1)
```
...
<!--
```{r}
p1 = ggplot(telco, aes(x=gender,fill=Churn))+ geom_bar()+theme_bw()
p2 = ggplot(telco, aes(x=SeniorCitizen,fill=Churn))+ geom_bar(position = 'fill')+theme_bw()
p3 = ggplot(telco, aes(x=Partner,fill=Churn))+ geom_bar(position = 'fill')+theme_bw()
p4 = ggplot(telco, aes(x=Dependents,fill=Churn))+ geom_bar(position = 'fill')+theme_bw()
p5 = ggplot(telco, aes(x=PhoneService,fill=Churn))+ geom_bar(position = 'fill')+theme_bw()
