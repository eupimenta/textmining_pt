...
db_cor = db1%>% 
  select(num_voted_users, num_user_for_reviews, num_critic_for_reviews, imdb_score, WR, movie_facebook_likes, cast_total_facebook_likes, budget, duration, title_year, gross, aspect_ratio)

#install.packages("Hmisc")
library(Hmisc)
res <- rcorr(as.matrix(db_cor), type = "pearson")
res$P
...
chart.Correlation(db_cor, histogram=TRUE, pch=19)
```
-->
