...
setwd("D:/2018-2/IC/PROJETOS/PROJ2/RECOMMENDER-IMDB")
...
knitr::include_graphics("IMG/PLOTS/wordcloud.png")
```
...
```{r, out.width = "600px",echo = FALSE, eval = TRUE, message=FALSE, include = TRUE, fig.align="center"}
#knitr::include_graphics("D:/2018-2/IC/PROJETOS/PROJ2/RECOMMENDER-IMDB/IMG/popcorn.jpg")
knitr::include_graphics("IMG/PLOTS/3.Fig.Correlation.png")
```
...
#knitr::include_graphics("D:/2018-2/IC/PROJETOS/PROJ2/RECOMMENDER-IMDB/IMG/popcorn.jpg")
knitr::include_graphics("IMG/ntrees.png")
```
...
```{r, out.width = "400px",echo = FALSE, eval = TRUE, message=FALSE, include = TRUE, fig.align="center"}
knitr::include_graphics("IMG/MDS_plot_TREINO.jpg")
```

Gráfico multidimensional com a variável resposta da base de TESTE.
```{r, out.width = "400px",echo = FALSE, eval = TRUE, message=FALSE, include = TRUE, fig.align="center"}
knitr::include_graphics("IMG/MDS_plot_TESTE.jpg")
```
